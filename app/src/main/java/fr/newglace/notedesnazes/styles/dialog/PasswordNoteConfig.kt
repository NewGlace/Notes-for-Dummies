...
class PasswordNoteConfig @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) constructor(activity: Activity) : Dialog(activity, R.style.Theme_AppCompat_DayNight_Dialog) {
    ...
    init {
        ...
        size.reSizing(textView, passwordWidth, (passwordHeight * 0.8).toInt(), true, true)
        size.reSizing(imageView, (passwordWidth * 1.05).toInt(), (passwordHeight * 2.5).toInt())
